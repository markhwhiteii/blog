...
p1 <- ggplot(test, aes(x = trans_therm_pre, y = preds)) +
  geom_point() +
  geom_smooth() +
  theme_light()

p2 <- ggplot(test, aes(x = sdo, y = preds)) +
  geom_point() +
  geom_smooth(method = "lm") +
  theme_light()

p3 <- ggplot(test, aes(x = race, y = preds)) +
  geom_point() +
  theme_light()

p4 <- ggplot(test, aes(x = canvass_minutes, y = preds)) +
  geom_point() +
  geom_smooth() +
  theme_light()
